...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Reasoning = field.NewString(tableName, "reasoning")
	...
	_message.Attachments = field.NewString(tableName, "attachments")
