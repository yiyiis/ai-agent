...
func newUserInfo(db *gorm.DB, opts ...gen.DOOption) userInfo {
	...
	_userInfo.UserType = field.NewInt32(tableName, "user_type")
	_userInfo.HeadImage = field.NewString(tableName, "head_image")
...
type userInfo struct {
	...
	UserType  field.Int32  // 用户类型：1：超级管理员，2：管理员，3：普通用户
	HeadImage field.String // 用户头像
...
func (u *userInfo) updateTableName(table string) *userInfo {
	...
	u.HeadImage = field.NewString(table, "head_image")
...
func (u *userInfo) fillFieldMap() {
	...
	u.fieldMap["head_image"] = u.HeadImage
