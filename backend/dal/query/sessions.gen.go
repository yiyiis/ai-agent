...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.CompanyID = field.NewInt64(tableName, "company_id")
	_session.UserID = field.NewInt64(tableName, "user_id")
	_session.Title = field.NewString(tableName, "title")
	_session.Model = field.NewString(tableName, "model")
	_session.SystemPrompt = field.NewString(tableName, "system_prompt")
	_session.AutoSkill = field.NewBool(tableName, "auto_skill")
	_session.Interactive = field.NewBool(tableName, "interactive")
	_session.APIKeyID = field.NewInt64(tableName, "api_key_id")
	_session.LastContextTokens = field.NewInt64(tableName, "last_context_tokens")
	_session.MemoryExtractedUptoMessageID = field.NewInt64(tableName, "memory_extracted_upto_message_id")
...
type session struct {
	...
	AutoSkill                    field.Bool
	Interactive                  field.Bool
	APIKeyID                     field.Int64
	LastContextTokens            field.Int64
	MemoryExtractedUptoMessageID field.Int64
...
func (s *session) updateTableName(table string) *session {
	...
	s.SystemPrompt = field.NewString(table, "system_prompt")
	s.AutoSkill = field.NewBool(table, "auto_skill")
	s.Interactive = field.NewBool(table, "interactive")
	s.APIKeyID = field.NewInt64(table, "api_key_id")
	s.LastContextTokens = field.NewInt64(table, "last_context_tokens")
	s.MemoryExtractedUptoMessageID = field.NewInt64(table, "memory_extracted_upto_message_id")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["system_prompt"] = s.SystemPrompt
	s.fieldMap["auto_skill"] = s.AutoSkill
	s.fieldMap["interactive"] = s.Interactive
	s.fieldMap["api_key_id"] = s.APIKeyID
	s.fieldMap["last_context_tokens"] = s.LastContextTokens
	s.fieldMap["memory_extracted_upto_message_id"] = s.MemoryExtractedUptoMessageID
